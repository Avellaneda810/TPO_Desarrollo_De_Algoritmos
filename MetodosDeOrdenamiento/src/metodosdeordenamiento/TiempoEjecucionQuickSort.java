    ...
    public static void main(String[] args) {
        ...
        do{
           op = Integer.parseInt(JOptionPane.showInputDialog(null, "Elige una opcion \n"
               ...
               + "2.-Imprimir los 100.000 numeros ordenados con quick sort y ver su tiempo de ejecucion de este metodo\n"
               + "3.-Salir"));
           switch(op){
               case 1: 
               ...
               case 2: 
                   ...
                   System.out.println("Numeros ordenados con el metodo Quick sort"); 
